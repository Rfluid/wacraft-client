...
describe("WebhookSidebarComponent — scroll & store interaction", () => {
    let component: WebhookSidebarComponent;
    let store: jasmine.SpyObj<WebhookStoreService> & {
        searchValue: string;
    ...
    beforeEach(() => {
        const spy = jasmine.createSpyObj<WebhookStoreService>("WebhookStoreService", [
            "get",
            "getSearch",
            "getInitialSearch",
        ]);
        ...
        TestBed.configureTestingModule({
            ...
            providers: [
                { provide: WebhookStoreService, useValue: store },
                {
    ...
    it("calls store.get() near bottom when not searching", () => {
    ...
    it("respects search-mode gating flags", () => {
        store.searchValue = "x";
